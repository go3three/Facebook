...
client.connect(function(err) {
    ...
    client.query('Create table if not exists info (id SERIAL, first_name varchar(50),last_name varchar(50)\
                ,dob date,gender char(2),about text,image_url text ,firends int,username\
                 varchar(25),password varchar(50),primary key(id));', function(errorWrite, result) {
        if (errorWrite) {
